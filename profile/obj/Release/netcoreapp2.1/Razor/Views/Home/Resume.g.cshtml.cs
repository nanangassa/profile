#pragma checksum "/Users/TheKing/Projects/profile/profile/Views/Home/Resume.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5a10ba33a46b3f45fbeb3d124b18a48d8eebb262"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5a10ba33a46b3f45fbeb3d124b18a48d8eebb262", @"/Views/Home/Resume.cshtml")]
...
<hr />
    ...
    <li> Ability to communicate with the diversity in a technically-oriented interdisciplinary workplace</li>
          ...
          <table border=""1"">
             ...
             <tr>
                <td> Languages </td>
                <td> Java, HTML, CSS, JavaScript, PHP, Go, C, C++, Python, C#, Dart</td>
             </tr>
             <tr>
                <td> Networking </td>
            ...
            <tr>
                <td> Cloud</td>
                <td> Heroku, Docker, Kubernetes, VMware, Virtual box, Digital Ocean, AWS, Google Cloud, Bluemix</td>
             </tr>
             ...
             <tr>
                <td> Frameworks</td>
                <td> LAMP, Django, .NET Core(MVC)/EF5/Blazor, Node.js, Flutter</td>
             </tr>
             
                  <tr>
                <td> Quality assurance</td>
                <td> Agile, Kanban, Scrum, Unit testing</td>
             </tr>
                  ...
                  <tr>
                <td> Technologies</td>
                <td> Linux Kernel, Restful/Web API, RTOS, JDBC/ODBC, IIS, YAML, JSON, XML, Bash, Embedded Systems, Threads, IPC</td>
     ...
     ");
            WriteLiteral(@"         Computer Engineering/Computer Science <br/>
...
<p>
    ...
    We wrote a cross platform android and iOS app using our client’s REST API that enables political parties to register voters and all their data into a Firebase database while also providing their locatio");
            WriteLiteral(@"n on a map, showing various records like if they have already voted or not. The project has been done in an agile environment and is at its final stage with unit tests, widget tests and integration testing.
 </p>
            <br />
...
<p>
    ...
    As part of a competition posted on the Kaggle website by Google, we were challenged to analyze the Google Merchandise Store (also known as GStore, where Google swag is sold) customer dataset to predict revenue per customer by harnessing the power of Artificial intlligence. Several approaches were tried to train a model with one-year data of purchasing history using python, Sklearn, Numpy, panda and neural network architecture.
          ...
          <p>
              ...
              As part of the .Net course where I finished with flying colors I had to write a blog for the final project using the C# programming language with MS SQL server on an azure database and hosted in an IIS environment. The blog has a registration page for regular");
            WriteLiteral(@" users and administrators, blog page with multiple posts where each post can have multiple comments. Finally we have a list of bad word that has to be blurred if posted.
